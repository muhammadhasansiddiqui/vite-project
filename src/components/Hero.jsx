...
const Hero = () => {
  return (
    <section className="flex items-center h-screen text-gray-400 bg-gradient-to-r from-brown-900 to-brown-700 body-font">
      <div className="container flex flex-col items-center px-5 py-24 mx-auto md:flex-row">
        <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
          ...
          <p className="mb-8 text-lg leading-relaxed">
            Today's good mood is sponsored by coffee. <br /> Search for your
            coffee now.
          </p>
      ...
      <div
        className="absolute flex items-center p-4 space-x-4 rounded-lg bottom-10 left-10 bg-brown-800
          bg-red-300
          "
      >
        <img
